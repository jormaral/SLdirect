...
");
echo ("  <newsTitle>" . $organizacion->news_title . "</newsTitle>
");
echo ("  <newsBody>" . $organizacion->news_body . "</newsBody>
");
...
");
echo ("  <enpresarialGroup>" . $organizacion->grupoEmpresarial . "</enpresarialGroup>
");
echo ("  <telephone>" . $organizacion->telefono . "</telephone>
");
echo ("  <email>" . $organizacion->email . "</email>
");
...
echo ("  <capacities>
");
foreach ($capacidades as $capacidad) echo ("      <capacity capacity_code=\"" . $capacidad->capacidad_id->id . "\" sector_code=\"" . $capacidad->sector_id->id . "\" resources=\"" . $capacidad->recursos . "\" score=\"" . $capacidad->puntuacion . "\" billingProportion=\"" . $capacidad->porcentajeFacturacion . "\" description=\""  .$capacidad->descripcion . "\" />
");
echo ("  </capacities>
");
...
echo ("  <demands>
"); 
foreach ($demandas as $demanda) echo ("    <demand capacity_code=\"" . $demanda->capacidad_id->id . "\" sector_code=\""  .$demanda->sector_id->id . "\" description=\""  .$demanda->descripcion . "\" />
");
echo ("  </demands>
");
...
foreach ($asociaciones as $asociacion) echo ("    <associationMembership code=\"" . $asociacion->asociacion_id->id . "\" url=\"" . $asociacion->asociacion_id->url . "\" icon=\"" . $asociacion->asociacion_id->icon . "\" />
");
echo ("  </associationMemberships>
"); 

$eventos = $organizacion->getChildren ("evento");
echo ("  <events>
");
foreach ($eventos as $evento) {
echo ("    <event>
");
echo ("      <localization>" . $evento->localizacion . "</localization>
");
echo ("      <title>" . $evento->titulo . "</title>
");
echo ("      <description>" . $evento->descripcion . "</description>
");
echo ("      <date>" . $evento->fecha . "</date>
");
echo ("    </event>
");
		}
