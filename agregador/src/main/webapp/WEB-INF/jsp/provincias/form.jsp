...
<jsp:include page="/WEB-INF/jsp/header.jsp" >
	<jsp:param name="pageTitle" value="Editar Provincia"/>
</jsp:include>

<c:choose>
	<c:when test="${provincia.new}"><c:set var="method" value="post"/></c:when>
...
<c:choose>
	<c:when test="${provincia.new}">Nueva Provincia</c:when>
	<c:otherwise>Editar ${provincia}</c:otherwise>
</c:choose>			
		</span>
		</a>
		</li>
