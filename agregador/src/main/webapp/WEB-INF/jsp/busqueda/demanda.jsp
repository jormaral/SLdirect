...
<jsp:include page="/WEB-INF/jsp/header.jsp" >
	<jsp:param name="pageTitle" value="Buscador por Demanda"/>
</jsp:include>
...
<div class="breadcrumb">
	...
	<img src="<spring:url value="/static/images/breadcrumb.png" />">Buscador por Demanda
</div>
<img src="<spring:url value="/static/images/busquedaDemandaTitle.png" />" alt="Busqueda por Servicios"  />
