...
public abstract class AbstractOrganizacionPorCampo extends AbstractDatasetGenerator {
	...
	public Map<String, ? extends Number> generateDataset(OrganizacionFilter filter) throws ServiceException {
		...
		for(Organizacion organizacion : organizaciones){
			Integer val = null;
			String key = obtenerClave(organizacion);
	...
	protected abstract String obtenerClave(Organizacion organizacion);	
}
