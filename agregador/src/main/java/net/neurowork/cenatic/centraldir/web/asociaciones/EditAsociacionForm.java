 ...
 */
@Controller
@RequestMapping("/asociaciones/{asociacionId}/edit")
@SessionAttributes(types = Asociacion.class)
public class EditAsociacionForm {
	private final static Logger logger = LoggerFactory.getLogger(EditAsociacionForm.class);
	...
	public String setupForm(@PathVariable("asociacionId") int asociacionId, Model model) {
