...
class evento extends model {
	...
	function __construct(){
		$this->setRelativeTable("eventos");
		$this->Foreign("organizacion_id","organizacion","nombre");
		$this->children("organizacionEvento","evento_id");
	}

	function parseValidation(){
		$error_fields = array();;
		if ($this->organizacion_id == '') $this->organizacion_id = 0;
		$this->titulo = mysql_escape_string($this->titulo);
		$this->localizacion = mysql_escape_string($this->localizacion);
