...
foreach (explode(",",$_REQUEST["organizaciones"]) as $id)
	foreach ($organizacionSede->getList("organizacion_id=".$id) as $sede)
		$results[] = $sede;
