...
<!--		<link rel="stylesheet" href="lib/jquery.ui/themes/flora/flora.all.css" type="text/css" media="screen" title="Flora (Default)" />-->
		...
		<link type="text/css" href="lib/jquery.ui/css/ui-lightness/jquery-ui-1.8rc3.custom.css" rel="stylesheet" />	
		<script type="text/javascript" src="lib/jquery.ui/js/jquery-1.4.2.min.js"></script>
		<script type="text/javascript" src="lib/jquery.ui/development-bundle/ui/i18n/jquery.ui.datepicker-es.js"></script>	
		<script type="text/javascript" src="lib/jquery.ui/js/jquery-ui-1.8rc3.custom.min.js"></script>
		<script>
							...
							<table style="width:935px;border-spacing:0px;height:100%;" cellspacing="0">
								<tr>
									<td style="background:url(media/topdegrad.png);height:80px;padding:0px;padding-left:420px;text-align:right;padding-right:32px">
										...
										<?php 
										  $logged_organizacion = new organizacion();
										  $logged_organizacion->open($session->userid);
										  if ($logged_organizacion->username != "") {
										  	echo "<div class=\"logoutBox\">Bienvenido, " . $logged_organizacion->nombre;
										  	echo ("  <button onCLick=\"location='logout.php'\">Cerrar Sesión</button>");
										  	echo ("</div>");
										  }
										?>
									</td>
