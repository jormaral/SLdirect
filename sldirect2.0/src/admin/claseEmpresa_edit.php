...
if (array_key_exists("post",$_REQUEST)){
	try{
		...
		$claseEmpresa->nombre = $_POST["nombre"];
		$claseEmpresa->update();
...
?>
<h1>Clase de EMpresa::<?php echo $claseEmpresa->nombre?></h1>
<form method="post" action="claseEmpresa_edit.php?claseEmpresa_id=<?php echo $_REQUEST["claseEmpresa_id"]?>&post=1">
<table class="form">
	<tbody>
		<tr>
			<td>Nombre</td>
			<td><input type="text" name="nombre" size="50" value="<?php echo $claseEmpresa->nombre?>"></td>
		</tr>	
		<tr>
			<td colspan="2">
