	...
	<html>
		...
		<body>
			<div class="header">
				...
				<!--<a href="clasesEmpresas.php"><img src="../media/icons/16x16/building.png" />Clases de Empresa</a>			-->
				...
				<a href="directorios.php"><img src="../media/icons/16x16/book.png" />Directorios</a>
			</div>	
			<div class="body">
	<?php
}
