...
if (array_key_exists("post",$_REQUEST)){
	try{
		...
		$clasificacion->nombre = $_POST["nombre"];
		$clasificacion->codigo = $_POST["codigo"];
...
error_reporting(0);
?>
<h1>A&ntilde;adir Clasificaci&oacute;n</h1>
<form method="post" action="clasificacion_add.php?post=1">
<table class="form">
	<tbody>
		<tr>
			<td>C&oacute;digo CNAE</td>
			<td><input type="text" name="codigo" size="6" value="<?php echo $_POST["nombre"]?>" /></td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<input type="submit" value="Crear Clasificacion" />
			</td>
		</tr>
	</tbody>
</table>
