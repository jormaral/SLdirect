...
?>
<div class="breadcrumb"><img src="media/icons/16x16/house.png"><a href="index.php">Inicio</a><img src="media/breadcrumb.png"><img src="media/icons/16x16/zoom.png"><a href="busqueda.php">Buscador de Empresas</a><img src="media/breadcrumb.png">Buscador por Servicio</div>

<img src="media/busquedaServiciosTitle.png" alt="Busqueda por Servicios"  />
...
<?php
	$sectores = new sector();
	foreach ($sectores->getList("1=1 ORDER by nombre") as $sector)
	{
?>
...
<div id="mapa" class="ui-tabs-panel">
	...
	function search(){
		...
		//jQuery.getJSON("jsonOrganizacionesSectoresCapacidades.php?sectores="+sectores_query+"&capacidades="+capacidades_query,onReady);

		$.ajax({
		  url: "jsonOrganizacionesSectoresCapacidades.php?sectores="+sectores_query+"&capacidades="+capacidades_query,
		  cache: false,
		  dataType: "json",
		  success: onReady});
	}
