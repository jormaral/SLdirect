...
error_reporting(0);
$settings["datadriver.mysql.host"] = "localhost";
$settings["datadriver.mysql.username"] = "root";
$settings["datadriver.mysql.password"] = "root";
$settings["datadriver.mysql.database"] = "cenatic";
