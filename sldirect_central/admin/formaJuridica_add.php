...
error_reporting(0);
?>
<h1>A&ntilde;adir Forma Juridica</h1>
<form method="post" action="formaJuridica_add.php?post=1">
<table class="form">
	<tbody>
		<tr>
			<td>Nombre</td>
		...
		<tr>
			<td colspan="2">
				<input type="submit" value="Crear Forma Juridica" />
			</td>
		</tr>
	</tbody>
</table>
