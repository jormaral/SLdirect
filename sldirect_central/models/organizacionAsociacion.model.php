...
class organizacionAsociacion extends model {
	...
	function __construct(){
		$this->setRelativeTable("organizaciones_asociaciones");
		$this->Foreign("organizacion_id","organizacion","nombre");
		$this->Foreign("asociacion_id","asociacion","nombre");
	}
	...
	function parseValidation(){
		...
		if (is_numeric($this->organizacion_id)){
			...
			$error_fields[]="organizacion_id";}
		if ($this->asociacion_id == '') $this->asociacion_id = 0;
		if (is_numeric($this->asociacion_id)){
			if ($this->asociacion_id != (int)$this->asociacion_id)
				$error_fields[]="asociacion_id";
		}else{
			$error_fields[]="asociacion_id";}
		...
		$asociacion_check = new asociacion();
		$asociacion_check->open($this->asociacion_id);
		if ($asociacion_check->id != $this->asociacion_id) $error_fields[]="asociacion_id";
